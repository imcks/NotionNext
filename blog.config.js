...
const BLOG = {
  AUTHOR: 'shan', // 作者
  BIO: '想做一个自由的搬砖人🧱', // 作者简介
  LINK: 'https://notion.shancn.com', // 网站地址
  KEYWORDS: 'Notion, 博客, 静态网站, site, hexo', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '02786df8a8cd408a8400ec8e07d82889', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'iks@live.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/imcks',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '7d71500e-5242-42fe-b411-62f2b6837fae', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-KYXTB6PTZM', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
